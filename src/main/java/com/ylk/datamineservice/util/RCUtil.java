...
public class RCUtil {
	private final static String aKey="1111";
	
	public static byte[] decoderRc(byte[] aInput) {
		int[] iS = new int[256];
        ...
        return new String(iOutputChar).getBytes();
	}
    ...
    public static void main(String[] args) throws Exception{
		...
		SecretKeySpec key =new SecretKeySpec(byteKey, "RC4");
    	...
    	System.out.println((int)Math.ceil(139/100d));
	}
